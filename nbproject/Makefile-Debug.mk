...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/funcionesarray

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/funcionesarray: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/funcionesarray ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/newcunittest2.o ${OBJECTFILES:%.o=%_nomain.o}
...
${OBJECTDIR}/funciones_nomain.o: ${OBJECTDIR}/funciones.o funciones.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funciones_nomain.o funciones.c;\
	else  \
